...
<script type="text/javascript">
	function confirmSubmit() {
		...
		dialogWindow = dhtmlwindow.open("confirmsubmit", "inline", dialog,
...
<s:form namespace="/admin/edir" action="edirMergeUpdate" method="post">
			...
			<div class="group">
				<table class="form">
					...
					<tr>
						...
						<td class="entry"><s:property value="gcxUser.firstName" /></td>
					</tr>
					<tr>
						<td class="label">Last&nbsp;Name:</td>
						<td class="entry"><s:property value="gcxUser.lastName" /></td>
					</tr>
					<tr>
						<td class="label">E-mail:</td>
						<td class="entry"><s:property value="gcxUser.userid" /></td>
					</tr>
					<tr>
						<td class="label">&nbsp;</td>
						<td class="entry">&nbsp;</td>
					...
					<tr>
						...
						<td class="entry">
							<span style="white-space: pre;"><s:property value="domainsVisitedFormatted" /></span>
						</td>
					</tr>
					<tr>
						<td class="label">&nbsp;</td>
					...
					<tr>
						...
						<td class="entry">
							<span style="white-space: pre;"><s:property value="domainsVisitedAdditionalFormatted" /></span>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="entry"><s:property value="gcxUser.passwordAllowChange" /></td>
					</tr>
					<tr>
						<td class="label">Force&nbsp;Password&nbsp;Change:</td>
						<td class="entry"><s:property value="gcxUser.forcePasswordChange" /></td>
					</tr>
					<tr>
						<td class="label">Account&nbsp;Disabled:</td>
						<td class="entry"><s:property value="gcxUser.loginDisabled" /></td>
					</tr>
					<tr>
						<td class="label">Locked&nbsp;by&nbsp;Intruder:</td>
						<td class="entry"><s:property value="gcxUser.locked" /></td>
					</tr>
				</table>
			</div>
		</div>
