...
<c:set var="proxyAuthUri" value="${assertion.chainedAuthentications[fn:length(assertion.chainedAuthentications)-1].attributes['org.ccci.gto.cas.ProxiedCredentialsUri']}" scope="request" />
