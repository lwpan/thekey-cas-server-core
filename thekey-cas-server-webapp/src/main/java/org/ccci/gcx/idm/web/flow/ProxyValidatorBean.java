 ...
 *
 */
public class ProxyValidatorBean {

	protected static final Log log = LogFactory.getLog(ProxyValidatorBean.class);
	 ...
	 * @throws Exception
	 */
	public boolean processProxyValidation(ExternalContext a_externalContext) throws Exception
	{
        ...
        CasAuthenticationResponse casresponse = (CasAuthenticationResponse) authservice.handleProxyValidateRequest((casrequest));

        //if there was an error, we still return the xmlcontent that cas gave us as our message parm.
