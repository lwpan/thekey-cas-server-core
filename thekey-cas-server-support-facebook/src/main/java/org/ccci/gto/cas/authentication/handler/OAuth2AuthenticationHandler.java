...
public abstract class OAuth2AuthenticationHandler extends
    ...
    protected abstract boolean authenticateOAuth2Internal(
	    final OAuth2Credentials credentials) throws AuthenticationException;
