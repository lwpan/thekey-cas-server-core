...
function deactivate()
{
	confirmSubmit( "Confirm Dectivation", "Your changes will not be saved. Are you sure that you want to deactivate the user?", "deactivate" ) ;
}

function activate()
{
	confirmSubmit( "Confirm Activation", "Your changes will not be saved. Are you sure that you want to activate the user?", "activate" ) ;
}

function doAction( actionName, confirmOnChange )
{
	if ( ( confirmOnChange == true ) && ( changed == true ) ) {
		confirmSubmit( "Changes Made", "Your changes will not be saved. Do you want to continue?", actionName ) ;
	} else {
		document.getElementById( "updateAction" ).value = actionName ;
		document.edirUserUpdate.submit() ;
	}
...
<s:form namespace="/edir" action="edirUserUpdate" method="post">
...
<tr><td class="label">First&nbsp;Name:</td><td class="entry"><s:textfield name="gcxUser.firstName" size="64" maxlength="64" onchange="setChanged();"/></td></tr>
<tr><td class="label">Last&nbsp;Name:</td><td class="entry"><s:textfield name="gcxUser.lastName" size="64" maxlength="64" onchange="setChanged();"/></td></tr>
<tr><td class="label">E-mail:</td><td class="entry"><s:textfield name="gcxUser.userid" size="64" maxlength="64" onchange="setChanged();"/></td></tr>
...
<tr><td class="label">Domains Visited:</td><td class="entry">
<s:textarea cols="64" name="domainsVisitedFormatted" onchange="setChanged();"></s:textarea>
</td></tr>
<tr><td class="label">&nbsp;</td><td class="entry">&nbsp;</td></tr>
...
<tr><td class="label">Additional Domains Visited:</td><td class="entry">
<s:textarea cols="64" name="domainsVisitedAdditionalFormatted" onchange="setChanged();"></s:textarea>
</td></tr>
...
<tr><td class="label">Change&nbsp;Password:</td><td class="entry"><s:checkbox name="gcxUser.passwordAllowChange" onchange="setChanged();"/></td></tr>
<tr><td class="label">Force&nbsp;Password&nbsp;Change:</td><td class="entry"><s:checkbox name="gcxUser.forcePasswordChange" onchange="setChanged();"/></td></tr>
<tr><td class="label">Account&nbsp;Disabled:</td><td class="entry"><s:checkbox name="gcxUser.loginDisabled" onchange="setChanged();"/></td></tr>
<tr><td class="label">Locked&nbsp;by&nbsp;Intruder:</td><td class="entry"><s:checkbox name="gcxUser.locked" onchange="setChanged();"/></td></tr>
</table>
