...
<s:form namespace="/edir" action="%{#session['searchactionname']}" method="post">
...
<div class="group">
<table class="form">
<tr><td class="label">First&nbsp;Name:</td><td class="entry"><s:textfield id="firstName" name="firstName" size="64" maxlength="64"/></td></tr>
<tr><td colspan="2" style="text-align: center; padding-top: 0.25em; padding-bottom: 0.25em; font-weight: bold;">or</td></tr>
<tr><td class="label">Last&nbsp;Name:</td><td class="entry"><s:textfield id="lastName" name="lastName" size="64" maxlength="64"/></td></tr>
<tr><td colspan="2" style="text-align: center; padding-top: 0.25em; padding-bottom: 0.25em; font-weight: bold;">or</td></tr>
<tr><td class="label">E-mail:</td><td class="entry"><s:textfield id="email" name="email" size="64" maxlength="64"/></td></tr>
</table>
</div> <!-- End Group -->
</div> <!-- End Groupbox -->
...
<s:if test="%{#session['usersearchresponse'] != null}">
<table id="userSearchResults" style="width: 900px; padding: 0; margin: 0; border: none; background: white;">
<tr>
...
of <s:property value="session.usersearchresponse.pageCount"/></b>
