...
public class FilteredImportCssFilter extends AbstractRuleCssFilter implements ReversibleFilter {
        ...
        if (rule instanceof CSSImportRule && rule.getType() == CSSRule.IMPORT_RULE) {
            ...
            // so we generate and parse an @import rule to update the href
                ...
                try {
                    ...
                    rule.setCssText("@import \"" + uri.toString() + "\" " + iRule.getMedia().getMediaText() + ";");
